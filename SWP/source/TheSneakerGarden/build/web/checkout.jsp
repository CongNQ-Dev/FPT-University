...
User user = userManager.getUser(userSession.getUserId());
%>
<!DOCTYPE html>
<html lang="en">
    <head>
                        ...
                        <form class="needs-validation" novalidate action="checkout" method="POST">
                            <div class="row g-3">
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="firstName" placeholder="" value="<%=user.getUserName()%>" required>
                                ...
                                <div class="col-sm-6">
                                    ...
                                    <input type="text" class="form-control" id="lastName" placeholder="" value="<%=user.getUserPhone()%>" required>
                                    <div class="invalid-feedback">
                                ...
                                <div class="col-12">
                                    ...
                                    <input type="text" class="form-control" id="address" value="<%=user.getUserAddress()%>" required>
                                    <div class="invalid-feedback">
