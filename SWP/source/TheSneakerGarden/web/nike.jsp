                        ...
                        <div class="col-md-4">
                            <div class="card mb-4 product-wap rounded-0">
                                <div class="card rounded-0">
                                    <img class="card-img rounded-0 img-fluid" src="./img/<%=list.get(i).getImage()%>" />
                                    <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
                                        <ul class="list-unstyled">
                                            ...
                                            <li><a class="btn mt-2 btn-main" href="/TheSneakerGarden/addToCart?action=add&id=<%=list.get(i).getId()%>" tabindex="0" ><i class="bi bi-cart-plus-fill"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
